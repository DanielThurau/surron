...
const ResourceViewer: React.FC<ResourceViewerProps> = ({ onNavigateHome }) => {
  ...
  useEffect(() => {
    const allResources: Resource[] = [
      // Images
      { name: 'img1.png', type: 'image', path: '/img1.png', title: 'Image 1' },
      { name: 'img3.png', type: 'image', path: '/img3.png', title: 'Image 3' },
      { name: 'img4.png', type: 'image', path: '/img4.png', title: 'Image 4' },
      { name: 'img5a.png', type: 'image', path: '/img5a.png', title: 'Image 5A' },
      { name: 'img5b.png', type: 'image', path: '/img5b.png', title: 'Image 5B' },
      { name: 'img6.png', type: 'image', path: '/img6.png', title: 'Image 6' },
      { name: 'img7.png', type: 'image', path: '/img7.png', title: 'Image 7' },
      { name: 'img8.png', type: 'image', path: '/img8.png', title: 'Image 8' },
      { name: 'img8b.png', type: 'image', path: '/img8b.png', title: 'Image 8B' },
      { name: 'img9.png', type: 'image', path: '/img9.png', title: 'Image 9' },
      { name: 'img10.png', type: 'image', path: '/img10.png', title: 'Image 10' },
      { name: 'img11.png', type: 'image', path: '/img11.png', title: 'Image 11' },
      { name: 'img12.png', type: 'image', path: '/img12.png', title: 'Image 12' },
      { name: 'img13.png', type: 'image', path: '/img13.png', title: 'Image 13' },
      { name: 'img14.png', type: 'image', path: '/img14.png', title: 'Image 14' },
      { name: 'img15.png', type: 'image', path: '/img15.png', title: 'Image 15' },
      { name: 'img16.png', type: 'image', path: '/img16.png', title: 'Image 16' },
      { name: 'img17.png', type: 'image', path: '/img17.png', title: 'Image 17' },
      { name: 'img18.png', type: 'image', path: '/img18.png', title: 'Image 18' },
      { name: 'img19.png', type: 'image', path: '/img19.png', title: 'Image 19' },
      { name: 'img20.png', type: 'image', path: '/img20.png', title: 'Image 20' },
